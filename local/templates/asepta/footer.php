            ...
            <div class="footer__item footer__item--big footer__list">
                    ...
                    <div class="footer__list-column">
                            ...
                            $APPLICATION->IncludeComponent(
                                ...
                                array(
                                    ...
                                    "COMPONENT_TEMPLATE" => "footer-menu-left",
                                    "CHILD_MENU_TYPE" => "",
                                    "USE_EXT" => "N",
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    array(
                        ...
                        "COMPONENT_TEMPLATE" => "footer-policy_menu",
                        "CHILD_MENU_TYPE" => "",
                        "USE_EXT" => "N"
                    ),
                    false
            ...
            <div class="footer__item footer__item--big footer__contacts">
                <img
                    class="footer__contacts-picture"
                     src="/assets/img/footer-maskot.png"
                     alt="asepta maskot"
                ...
                <div class="footer__contacts-bottom">
                    ...
                    <?php $APPLICATION->IncludeComponent(
                        ...
                        [
                            'AREA_FILE_SHOW' => 'file',
                            'PATH' => SITE_TEMPLATE_PATH . '/include_area/' . SITE_ID . '/template_email.php',
                        ],
                        true
                    );?>
                </div>
            ...
            <div class="footer__item footer__add">
                ...
                <div class="footer__add-main">
                    <?php $APPLICATION->IncludeComponent(
                        ...
                        [
                            'AREA_FILE_SHOW' => 'file',
                            'PATH' => SITE_TEMPLATE_PATH . '/include_area/' . SITE_ID . '/template_footer_text.php',
                        ],
                        true
                    );?>
                </div>
                <div class="footer__add-copyrite">
                    <p><?= Loc::getMessage('FOOTER_DEVELOPER') ?>
                    </p>
                </div>
            </div>
        </footer>
